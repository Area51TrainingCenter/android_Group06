...
public class MainActivity extends Activity {
	...
	private static final String ALBUM_NAME = "grupo06";
		...
		if (resultCode == RESULT_OK) {
			...
			case TAKE_PICTURE: {
				if (currentPhotoPath != null) {
					mImageBitmap = BitmapManager.setPic(pictureTaken,
							currentPhotoPath);
			...
			case SELECT_PICTURE: {
				...
				currentPhotoPath = AlbumStorageDirFactory
						.getImageFromGalleryPath(this, selectedImageUri);
